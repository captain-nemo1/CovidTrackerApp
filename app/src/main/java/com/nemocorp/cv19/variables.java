...
public class variables {
    ...
    static List<String> death_inc= new ArrayList<>();
    static List<String> recovered_inc= new ArrayList<>();
    static List<String> active_inc= new ArrayList<>();
    static List<String> confirmed_inc= new ArrayList<>();
    ...
    static List<String> dis_confirmed_inc= new ArrayList<>();
    static List<String> dis_death_inc= new ArrayList<>();
    static List<String> dis_recovered_inc= new ArrayList<>();
    ...
    static List<String> world_confirmed_inc= new ArrayList<>();
    static List<String> world_death_inc= new ArrayList<>();
    static List<String> world_recovered_inc= new ArrayList<>();
